...
const getRouteConfigsFromChildren = children => {
  const configs = React.Children.toArray(children).reduce((acc, child) => {
    ...
    ((_child$type = child.type) === null || _child$type === void 0 ? void 0 : _child$type.name) ? child.type.name : String(child), "'). To render this component in the navigator, pass it in the 'component' prop to 'Screen'."));
  }, []);
